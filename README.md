...
- `use_base_model` (0/1) indicates to BUZZ to use a hand coded controller for the robots. This should be used in conjunction with setting both `--learning_scheme` and `--comms_scheme` to None and setting the flag `--test`
