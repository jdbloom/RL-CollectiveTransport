...
# # 690 (), 960 (), 970 ()
# declare -a episodes=(590 600 620 630 640 660 670 680 690 960 970)
...
declare -a episodes=(680 560 570 580)
cd pytorch
cd python_code
for e in "${episodes[@]}"
do
...
curriculum=0
experiment_name="${learning_scheme}_Recurrent_4Obs_Model_${e}"
mkdir "/home/endurance/RDDPG/Testing_Data/${learning_scheme}_Intention/recurrent/4_obstacles/$experiment_name/Plots"
sleep 1
# recording_path="/home/endurance/RDDPG/Testing_Data/${learning_scheme}_Intention/recurrent/gate/$experiment_name"
# model_path="/home/endurance/RDDPG/Testing_Data/${learning_scheme}_Intention/recurrent/gate/Models/Episode_${e}"
# port="55555"
...
echo "$experiment_name Plotting ...."
python3 -u viz.py /home/endurance/RDDPG/Testing_Data/${learning_scheme}_Intention/recurrent/4_obstacles/$experiment_name/ /home/endurance/RDDPG/Testing_Data/${learning_scheme}_Intention/recurrent/4_obstacles/$experiment_name/Plots/ ${learning_scheme}_recurrent_4_obstacles_${e}
